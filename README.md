...
1. Upload both `.html` files to this repository
...
| File | Description |
|------|-------------|
| `activity2-mission-design.html` | Grades 6–9 simulation |
| `Aerospace_Instructor_Guide.docx` | Printable instructor handoff guide |
| `README.md` | This file |
